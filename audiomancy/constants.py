...
GRAPH_PATH = os.path.join(os.path.abspath(os.path.join(ABSOLUTE_PATH,'..')),'graphs')
OUTPUT_PATH = os.path.join(os.path.abspath(os.path.join(ABSOLUTE_PATH,'..')),'outputs')

CONFIGS = os.path.join(ABSOLUTE_PATH,'common','configs')
